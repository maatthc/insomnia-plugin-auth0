...
<template>
  <div class="a0-instance notice info">
    ...
    <div style="flex: 2;"><button type="button" tabindex="0"
        ...
        data-rac="" id="react-aria7835462272-:r24:" style="touch-action: pan-x pan-y pinch-zoom;"><svg
          aria-hidden="true" focusable="false" data-prefix="fas" data-icon="user-plus"
          class="svg-inline--fa fa-user-plus " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
        ...
        </svg><span class="truncate">{{ authenticated ? 'Logout' : 'Authenticate' }}</span></button></div>
  </div>
</template>
